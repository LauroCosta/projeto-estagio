...
export class createProfessionalAndSpeciality1599615233969 implements MigrationInterface {
    name = 'createProfessionalAndSpeciality1599615233969'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "professionals_specialties_specialties" ADD CONSTRAINT "FK_d90f1427f1e26b600ce28139a15" FOREIGN KEY ("professionalsId") REFERENCES "professionals"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "professionals_specialties_specialties" ADD CONSTRAINT "FK_65f0319b9c3160dd0a3012b3573" FOREIGN KEY ("specialtiesId") REFERENCES "specialties"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
